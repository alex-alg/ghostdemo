    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form class="" method="post" action="{{ route('admin.voucher.store') }}">
                        ...
                        <div class="form-group {{ $errors->has('voucher.code') ? ' has-error' : '' }}">
                            ...
                            <div class="col-lg-10">
                                <input type="text" class="form-control" id="code" name="voucher[code]" placeholder="code">
                        ...
                        <div class="form-group {{ $errors->has('voucher.discount_percentage') ? ' has-error' : '' }}">
                            ...
                            <div class="col-lg-10">
                                <input type="text" class="form-control" id="discount_percentage" name="voucher[discount_percentage]" placeholder="discount percentage">
