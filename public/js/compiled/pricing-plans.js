...
var vm = new __WEBPACK_IMPORTED_MODULE_1_vue___default.a({
	...
	methods: {
		refreshPlanList: function refreshPlanList(discountPercentage) {
			this.$refs.planList.applyDiscountToPlans(discountPercentage);
		}
	},

	components: {
		'plans-list': __webpack_require__(18),
		'apply-voucher-form': __webpack_require__(39)
	}
});
...
Component.options.__file = "resources\\assets\\js\\plans\\plans-list.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-5788e1d2", Component.options)
  } else {
    hotAPI.reload("data-v-5788e1d2", Component.options)
  }
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    initPlansData: function initPlansData() {
      var self = this;
      self.is_loading = true;

      __WEBPACK_IMPORTED_MODULE_0_axios___default.a.post(this.links.getPlansDataUrl).then(function (response) {
    ...
    applyDiscountToPlans: function applyDiscountToPlans(discountPercentage) {
      var self = this;

      console.log(discountPercentage);

      if (discountPercentage !== null) {
        self.plans = self.plans.map(function (plan) {
          var newPlan = plan;
  ...
  components: {
    'v-simple-spinner': __webpack_require__(11)
  }
});
  ...
  return _c("div", [
    _c("div", { staticClass: "row" }, [
      _c(
        ...
        [
          _vm.is_loading == true
            ? _c("v-simple-spinner", { attrs: { size: "huge" } })
            : _vm._e()
        ],
        1
      )
        ...
        directives: [
          {
            name: "show",
            rawName: "v-show",
            value: _vm.is_loading === false,
            expression: "is_loading === false"
          }
        ],
        staticClass: "row"
      },
        ...
        return _c("div", { staticClass: "col-md-6" }, [
          _c("div", { staticClass: "card bg-info" }, [
            ...
            _c(
              ...
              [
                _c("h4", [_vm._v("OS: " + _vm._s(plan.os))]),
                _vm._v(" "),
                _c("p", [_vm._v("Features:")]),
                _vm._v(" "),
                _vm._l(plan.features, function(feature) {
                  return _c("p", [_vm._v(_vm._s(feature.name))])
                })
              ],
              2
            ),
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-5788e1d2", module.exports)
  }
}
...
Component.options.__file = "resources\\assets\\js\\voucher\\apply-voucher-form.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-2b7acfa2", Component.options)
  } else {
    hotAPI.reload("data-v-2b7acfa2", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_axios__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_axios___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_axios__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__helpers_form_form_js__ = __webpack_require__(41);
//
//
//
//
...
var render = function() {
  ...
  return _c("div", { staticClass: "row" }, [
    _c("div", { staticClass: "card bg-secondary" }, [
      _c("div", { staticClass: "card-header" }, [
        _vm._v(_vm._s(_vm.labels.headerLabel))
      ]),
      _vm._v(" "),
      _c(
        "div",
          ...
          _c("div", { staticClass: "row" }, [
            _c("div", { staticClass: "col-md-12" }, [
              _c(
                ...
                [
                  _c("div", { staticClass: "card-header" }, [
                    _vm._v(_vm._s(_vm.labels.applySuccessMessage))
                  ])
                ]
              ),
              _vm._v(" "),
              _c(
                ...
                [
                  _c("div", { staticClass: "panel-header" }, [
                    _vm._v(_vm._s(_vm.labels.applyErrorMessage))
                  ])
                ]
              ),
              _vm._v(" "),
          ...
          _c(
            ...
            [
              ...
              _c(
                ...
                [_vm._v(_vm._s(_vm.labels.applyButtonLabel))]
              )
            ]
          )
        ],
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-2b7acfa2", module.exports)
  }
}
